...
var Impl = _interopRequire(require("./agent-impl"));
...
var AgentComponent = (function (_React$Component) {
  ...
  _createClass(AgentComponent, {
    ...
    requestTo: {
      value: function requestTo(action /* [, ...args] [, callback] */) {
        var args = [];
...
},{"./agent-impl":8,"_process":1,"react":165}],4:[function(require,module,exports){
(function (process){
"use strict";
...
module.exports = {
  ...
  requestTo: function requestTo(action /* [, ...args] [, callback] */) {
    var args = [];
    var lastIndex = arguments.length - 1;
    var callback = undefined;
    if (lastIndex >= 1) {
...
},{"./agent-impl":8,"_process":1}],5:[function(require,module,exports){
(function (process){
"use strict";
 ...
 */
exports.createSentActionEvent = createSentActionEvent;
...
function setUnified(component, value, resolve, reject) {
  ...
  // If value is a Promise, wait for fulfilled and set the result.
    ...
    value.then(function (result) {
      return setUnified(component, result, resolve, reject);
    }, reject);
  }
...
function createSentActionEvent(action, args, callback) {
  if (process.env.NODE_ENV !== "production") {
  ...
  Object.defineProperties(event, {
    ...
    applyTo: { value: function applyTo(component) {
        if (process.env.NODE_ENV !== "production") {
          ...
          var set = Object.getOwnPropertyDescriptor(component, "setStageValue");
          invariant(isFunction(get.get), "component.stageValue should be a getter property.");
          invariant(isFunction(set.value), "component.setStageValue should be a function.");
        ...
        setUnified(component, value, function (result) {
...
var Impl = _interopRequire(require("./stage-impl"));
...
},{"./stage-impl":10,"react":165}],7:[function(require,module,exports){
"use strict";
...
},{"./stage-impl":10}],8:[function(require,module,exports){
(function (process){
"use strict";
...
var createSentActionEvent = require("./SentActionEvent").createSentActionEvent;
...
module.exports = {
  ...
  sendAction: function sendAction(component, action, args, callback) {
    var node = React.findDOMNode(component);
    var event = createSentActionEvent(action, args, callback);
...
},{"./SentActionEvent":5,"_process":1,"react":165}],9:[function(require,module,exports){
"use strict";
...
var AgentComponent = _interopRequire(require("./AgentComponent"));

var AgentMixin = _interopRequire(require("./AgentMixin"));

var StageComponent = _interopRequire(require("./StageComponent"));

var StageMixin = _interopRequire(require("./StageMixin"));

exports["default"] = {
  AgentComponent: AgentComponent,
  AgentMixin: AgentMixin,
  StageComponent: StageComponent,
  StageMixin: StageMixin
};
exports.AgentComponent = AgentComponent;
exports.AgentMixin = AgentMixin;
exports.StageComponent = StageComponent;
exports.StageMixin = StageMixin;

},{"./AgentComponent":3,"./AgentMixin":4,"./StageComponent":6,"./StageMixin":7}],10:[function(require,module,exports){
(function (process){
"use strict";
...
var EVENT_NAME = require("./SentActionEvent").EVENT_NAME;
...
module.exports = {
  ...
  teardownHandler: function teardownHandler(component) {
    var node = React.findDOMNode(component);
    if (node != null) {
      node.removeEventListener(EVENT_NAME, component.stageMixinHandleSentAction);
    }
  }
};

}).call(this,require('_process'))
},{"./SentActionEvent":5,"_process":1,"react":165}],11:[function(require,module,exports){
/**
...
exports.removeAllCompletedTodoItems = removeAllCompletedTodoItems;
exports.updateTodoTitle = updateTodoTitle;
exports.updateTodoCompleted = updateTodoCompleted;
exports.updateAllTodoCompleted = updateAllTodoCompleted;
exports.updateShownKind = updateShownKind;
exports.save = save;
exports.load = load;

var _Seq = require("immutable");

var _TodoApp = require("../model/TodoApp");

var _TodoApp2 = _interopRequireWildcard(_TodoApp);

var _TodoItem = require("../model/TodoItem");

var _TodoItem2 = _interopRequireWildcard(_TodoItem);

function addTodoItem(model, title) {
  return model.withItems(function (items) {
    return items.unshift(new _TodoItem2["default"](title.trim()));
  });
}

function removeTodoItem(model, id) {
  return model.withItems(function (items) {
...
function removeAllCompletedTodoItems(model) {
  return model.withItems(function (items) {
    return items.filter(function (item) {
...
function updateTodoTitle(model, id, value) {
  return model.withItems(function (items) {
    return items.map(function (item) {
      return item.id !== id ? item : item.withTitle(value.trim());
    });
  });
}

function updateTodoCompleted(model, id, value) {
  return model.withItems(function (items) {
    return items.map(function (item) {
      return item.id !== id ? item : item.withCompleted(value);
    });
  });
}

function updateAllTodoCompleted(model, value) {
  return model.withItems(function (items) {
    return items.map(function (item) {
      return item.withCompleted(value);
    });
  });
}

function updateShownKind(model, value) {
...
function load() {
  if (typeof localStorage !== "undefined") {
    var serialized = localStorage.getItem("todos");
    if (serialized) {
      var items = _Seq.Seq(JSON.parse(serialized)).map(function (item) {
        return new _TodoItem2["default"](item);
      }).toList();

      return new _TodoApp2["default"]({ items: items });
    }
  }
  return new _TodoApp2["default"]();
}

},{"../model/TodoApp":168,"../model/TodoItem":169,"immutable":2}],167:[function(require,module,exports){
"use strict";
...
var _TodoApp = require("./view/TodoApp");

var _TodoApp2 = _interopRequireWildcard(_TodoApp);

var _save$load = require("./action/TodoApp");

var app = _React2["default"].render(_React2["default"].createElement(_TodoApp2["default"], { initialModel: _save$load.load() }), document.getElementById("main"));

if (typeof addEventListener === "function") {
  addEventListener("unload", function () {
    _save$load.save(app.stageValue);
  });
}

},{"./action/TodoApp":166,"./view/TodoApp":173,"react":165}],168:[function(require,module,exports){
"use strict";
...
var TodoApp = (function (_Record) {
  ...
  _createClass(TodoApp, [{
    ...
    get: function () {
      switch (this.shownKind) {
        case ACTIVE:
          return this.items.toSeq().filter(function (item) {
            return item.completed === false;
          });
    ...
    key: "countItems",
    value: function countItems(shownKind) {
      switch (shownKind) {
        case ACTIVE:
        ...
        case COMPLETED:
          return this.items.reduce(function (count, item) {
            return item.completed ? 1 + count : count;
          }, 0);
    ...
    key: "withItems",
    value: function withItems(mutator) {
      return this.set("items", mutator(this.items));
    }
  }, {
    key: "withShownKind",
    value: function withShownKind(value) {
  ...
  items: _List$Record.List(),
  shownKind: ALL
}));

exports["default"] = TodoApp;

},{"./TodoItem":169,"immutable":2}],169:[function(require,module,exports){
"use strict";
...
function generateId() {
  var n = generateId.n;
  generateId.n = n === 1048575 ? 0 : 1 + n;
  return Date.now().toString(16) + ("0000" + n.toString(16)).slice(-5);
}
generateId.n = 0;

var TodoItem = (function (_Record) {
  function TodoItem(objOrTitle) {
    _classCallCheck(this, TodoItem);

    _get(Object.getPrototypeOf(TodoItem.prototype), "constructor", this).call(this, objOrTitle && objOrTitle.id != null ? objOrTitle : { id: generateId(), title: String(objOrTitle) });
  }

  _inherits(TodoItem, _Record);

  _createClass(TodoItem, [{
    key: "withTitle",
    value: function withTitle(value) {
      return this.set("title", value);
    }
  }, {
    key: "withCompleted",
    value: function withCompleted(value) {
...
},{"immutable":2}],170:[function(require,module,exports){
"use strict";

var _SHOWN_BUTTON_TEXT;
...
var _AgentComponent2 = require("react-helix");

var _css = require("../../../util/css.js");

var _css2 = _interopRequireWildcard(_css);

var _ACTIVE$COMPLETED$ALL = require("../model/TodoApp");

var _removeAllCompletedTodoItems$updateShownKind = require("../action/TodoApp");

var SHOWN_KINDS = [_ACTIVE$COMPLETED$ALL.ACTIVE, _ACTIVE$COMPLETED$ALL.COMPLETED, _ACTIVE$COMPLETED$ALL.ALL];
var SHOWN_BUTTON_TEXT = (_SHOWN_BUTTON_TEXT = {}, _defineProperty(_SHOWN_BUTTON_TEXT, _ACTIVE$COMPLETED$ALL.ACTIVE, "Active"), _defineProperty(_SHOWN_BUTTON_TEXT, _ACTIVE$COMPLETED$ALL.COMPLETED, "Completed"), _defineProperty(_SHOWN_BUTTON_TEXT, _ACTIVE$COMPLETED$ALL.ALL, "All"), _SHOWN_BUTTON_TEXT);

var Footer = (function (_AgentComponent) {
  ...
  _inherits(Footer, _AgentComponent);
  ...
  _createClass(Footer, [{
    ...
    value: function render() {
      ...
      var countAll = this.props.countAll;
      var countCompleted = this.props.countCompleted;
      var shownKind = this.props.shownKind;
      ...
      return _React2["default"].createElement(
        ...
        _React2["default"].createElement(
          "span",
          { className: "todo-clear" + (countCompleted > 0 ? " exists" : "") },
          _React2["default"].createElement(
            "button",
        ...
        _React2["default"].createElement(
          "span",
          { className: "todo-shown-kind" },
          SHOWN_KINDS.map(function (kind) {
            return _React2["default"].createElement(
              "button",
              {
                key: kind,
                ...
                "data-kind": kind,
                onClick: _this.onSwitchKindButtonClick
              },
    ...
    value: function onClearButtonClick() {
      this.requestTo(_removeAllCompletedTodoItems$updateShownKind.removeAllCompletedTodoItems);
    }
  }, {
    key: "onSwitchKindButtonClick",
    value: function onSwitchKindButtonClick(event) {
      var kind = Number(event.target.dataset.kind);
      this.requestTo(_removeAllCompletedTodoItems$updateShownKind.updateShownKind, kind);
    }
  }]);

  return Footer;
})(_AgentComponent2.AgentComponent);

exports["default"] = Footer;

Footer.displayName = "Footer";
Footer.propTypes = {
  countAll: _React2["default"].PropTypes.number.isRequired,
  countCompleted: _React2["default"].PropTypes.number.isRequired,
  shownKind: _React2["default"].PropTypes.oneOf(SHOWN_KINDS).isRequired
};
...
},{"../../../util/css.js":176,"../action/TodoApp":166,"../model/TodoApp":168,"react":165,"react-helix":9}],171:[function(require,module,exports){
"use strict";
...
var _updateAllTodoCompleted = require("../action/TodoApp");

var _NewTodoInput = require("./NewTodoInput");

var _NewTodoInput2 = _interopRequireWildcard(_NewTodoInput);

var Header = (function (_AgentComponent) {
  ...
  _inherits(Header, _AgentComponent);

  _createClass(Header, [{
    key: "render",
    value: function render() {
      var countActive = this.props.countActive;

      return _React2["default"].createElement(
        "div",
        { className: "todo-header" },
        _React2["default"].createElement("div", { className: "todo-header-bar" }),
        ...
        _React2["default"].createElement(_NewTodoInput2["default"], null)
      );
    }
  }, {
    ...
    value: function onCompletedChange(event) {
      ...
      this.requestTo(_updateAllTodoCompleted.updateAllTodoCompleted, value);
    }
  }]);
...
Header.propTypes = {
  countActive: _React2["default"].PropTypes.number.isRequired
};
...
},{"../../../util/css.js":176,"../action/TodoApp":166,"./NewTodoInput":172,"react":165,"react-helix":9}],172:[function(require,module,exports){
"use strict";
...
var _addTodoItem = require("../action/TodoApp");

var NewTodoInput = (function (_AgentComponent) {
  function NewTodoInput(props) {
    _classCallCheck(this, NewTodoInput);

    _get(Object.getPrototypeOf(NewTodoInput.prototype), "constructor", this).call(this, props);
    this.onKeyDown = this.onKeyDown.bind(this);
  }

  _inherits(NewTodoInput, _AgentComponent);

  _createClass(NewTodoInput, [{
    key: "render",
    value: function render() {
    ...
    value: function onKeyDown(event) {
      if (event.keyCode === 13) {
        ...
        var title = _input.value.trim();
        _input.value = "";
        if (title !== "") {
          this.requestTo(_addTodoItem.addTodoItem, title);
        }
      }
    }
  }]);
...
},{"../../../util/css.js":176,"../action/TodoApp":166,"react":165,"react-helix":9}],173:[function(require,module,exports){
"use strict";
...
var _StageComponent2 = require("react-helix");

var _css = require("../../../util/css.js");

var _css2 = _interopRequireWildcard(_css);

var _TodoAppModel = require("../model/TodoApp");

var _TodoAppModel2 = _interopRequireWildcard(_TodoAppModel);
...
var TodoApp = (function (_StageComponent) {
  function TodoApp(props) {
    _classCallCheck(this, TodoApp);

    _get(Object.getPrototypeOf(TodoApp.prototype), "constructor", this).call(this, props, "model");
    this.state = {
      model: props && props.initialModel || new _TodoAppModel2["default"]()
    };
  }

  _inherits(TodoApp, _StageComponent);

  _createClass(TodoApp, [{
    key: "render",
    value: function render() {
      var model = this.stageValue;
      var todoItems = model.shownItems;
      var countActive = model.countItems(_TodoAppModel2["default"].ACTIVE);
      var countCompleted = model.countItems(_TodoAppModel2["default"].COMPLETED);
      var countAll = countActive + countCompleted;
      var shownKind = model.shownKind;

      return _React2["default"].createElement(
        "div",
        { className: "todo-app" },
        _React2["default"].createElement(_Header2["default"], { countActive: countActive }),
        _React2["default"].createElement(_TodoList2["default"], { value: todoItems }),
  ...
  return TodoApp;
})(_StageComponent2.StageComponent);

exports["default"] = TodoApp;

TodoApp.displayName = "TodoApp";
TodoApp.propTypes = {
  initialModel: _React2["default"].PropTypes.instanceOf(_TodoAppModel2["default"])
};

_css2["default"]("\n.todo-app {\n  position: relative;\n  width: 600px;\n  min-height: 300px;\n  margin: 24px auto;\n  background: white;\n  box-shadow: 0 8px 32px 8px rgba(0,0,0,0.5);\n  color: black;\n}\n\n.todo-app::before {\n  display: block;\n  content: \"\";\n  position: absolute;\n  left: 0.2em;\n  top: 100%;\n  width: calc(100% - 0.4em);\n  height: 0.125em;\n  background: #EEE;\n  border-top: 1px solid #9E9E9E;\n}\n\n@media (max-width: 640px) {\n  .todo-app {\n    width: 100%;\n    margin: 0;\n  }\n}\n");
module.exports = exports["default"];

},{"../../../util/css.js":176,"../model/TodoApp":168,"./Footer":170,"./Header":171,"./TodoList":175,"react":165,"react-helix":9}],174:[function(require,module,exports){
"use strict";
...
var _TodoItemModel = require("../model/TodoItem");

var _TodoItemModel2 = _interopRequireWildcard(_TodoItemModel);

var _removeTodoItem$updateTodoTitle$updateTodoCompleted = require("../action/TodoApp");

var TodoItem = (function (_AgentComponent) {
  ...
  _inherits(TodoItem, _AgentComponent);

  _createClass(TodoItem, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate() {
      var input = this.refs.titleEdit;
      if (input != null) {
        var dom = _React2["default"].findDOMNode(input);
    ...
    value: function render() {
      ...
      if (this.state.isEditing) {
        ...
        var _className = "todo-item" + (todo.completed ? " completed" : "");
        return _React2["default"].createElement(
          "li",
          { className: _className, key: todo.id },
          _React2["default"].createElement("input", {
          ...
          _React2["default"].createElement(
            "button",
            { className: "remove-button", onClick: this.onRemoveButtonClick },
            "✖"
          )
        );
      }
    ...
    key: "onEditBlur",
    value: function onEditBlur(event) {
      this.saveTitle(event.target.value);
    }
  }, {
    key: "onEditKeyDown",
    value: function onEditKeyDown(event) {
    ...
    value: function onCompletedChange(event) {
      ...
      var value = event.target.checked;
      this.requestTo(_removeTodoItem$updateTodoTitle$updateTodoCompleted.updateTodoCompleted, id, value);
    }
  }, {
    key: "onLabelDoubleClick",
    value: function onLabelDoubleClick() {
    ...
    value: function onRemoveButtonClick() {
      var id = this.props.value.id;
      this.requestTo(_removeTodoItem$updateTodoTitle$updateTodoCompleted.removeTodoItem, id);
    }
  }, {
    key: "saveTitle",
    value: function saveTitle(value) {
      var id = this.props.value.id;
      this.setState({ isEditing: false });
      if (value.trim() !== "") {
        this.requestTo(_removeTodoItem$updateTodoTitle$updateTodoCompleted.updateTodoTitle, id, value);
      }
    }
  }]);
...
TodoItem.propTypes = {
  value: _React2["default"].PropTypes.instanceOf(_TodoItemModel2["default"]).isRequired
};
...
},{"../../../util/css":176,"../action/TodoApp":166,"../model/TodoItem":169,"react":165,"react-helix":9}],175:[function(require,module,exports){
"use strict";
...
var _Iterable = require("immutable");
    ...
    value: function render() {
      ...
      return _React2["default"].createElement(
        ...
        list.map(function (todo) {
          return _React2["default"].createElement(_TodoItem2["default"], { key: todo.id, value: todo });
        })
      );
    }
  }]);
...
TodoList.propTypes = {
  value: _React2["default"].PropTypes.instanceOf(_Iterable.Iterable).isRequired
};

_css2["default"]("\n.todo-list {\n  margin: 0;\n  padding: 0.5em 0;\n  list-style: none;\n}\n");
module.exports = exports["default"];

},{"../../../util/css.js":176,"./TodoItem":174,"immutable":2,"react":165}],176:[function(require,module,exports){
"use strict";
